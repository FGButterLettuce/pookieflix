        ...
        <section className="settings-section">
          ...
          <div className="settings-field">
            ...
            <div className="setup-hint" style={{ marginBottom: 0 }}>
              Your PookieFlix box's local network address — used to bypass Cloudflare for uploads (large files are
              unreliable over the public tunnel) and for the upload shortcut on Home.
            </div>
          </div>
